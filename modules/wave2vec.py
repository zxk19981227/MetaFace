...
class Wav2Vec2Model(wav2vec_official):
    ...
    def forward(
        ...
        hidden_states = linear_interpolation(hidden_states, cfg.audio_fps, cfg.video_fps)
        ...
        if self.config.apply_spec_augment and self.training:
            ...
            if self.config.mask_time_prob > 0:
                ...
                hidden_states[torch.from_numpy(mask_time_indices)] = self.masked_spec_embed.type_as(hidden_states)
            if self.config.mask_feature_prob > 0:
                ...
                mask_feature_indices = torch.from_numpy(mask_feature_indices)
